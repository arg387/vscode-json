...
### Workbench Configuration
  ...
  - [x] window title edit option is added. You can add your name there with emoji's if you want. Just replace `User` part inside quotation ```"🫡 Hello User This is ${dirty}${activeFolderShort} folder" ``` with your name or whatever you wish to do in the json file in the downloaded zip folder. Don't edit the part inside `${}`.
...
### latest 
<img width="1918" height="1077" alt="{34B30C76-BF15-4597-A655-312A90A421E6}" src="https://github.com/user-attachments/assets/073acbcd-fe89-4564-86f4-f4ec548eb0b6" />
